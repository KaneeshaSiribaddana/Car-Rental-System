                    ...
                    <div class="col-md-6">
                        <div class="card dashboard-card text-white bg-primary">
                            <div class="card-body">
                                ...
                                <p class="card-text">₹<?= number_format($earningsAfterCharge, 2) ?></p>
                                <p class="small">Total before charges: ₹<?= number_format($totalEarnings, 2) ?></p>
                                <a href="payment_page.php" class="btn btn-light mt-3">Go to Payment</a>
                            </div>
                        </div>
                    </div>

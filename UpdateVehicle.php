...
require_once 'models/config.php'; // Assuming Database connection is set up here
        ...
        <div class="form-container">
            ...
            <form action="controllers/update_vehicle_process.php" method="POST" enctype="multipart/form-data" id="vehicleForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="owner" id="owner" value="<?= htmlspecialchars($vehicle['owner']) ?>" required>
                </div>
